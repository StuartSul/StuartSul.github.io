...
For more on my background, see my [LinkedIn](https://www.linkedin.com/in/stuartsul/).
...
* [**Retire the Abstractions**](https://hazyresearch.stanford.edu/blog/2026-08-05-retire-the-abstractions) (Aug 2026)
...
* [**ParallelKittens: Simple and Fast Multi-GPU AI Kernels**](https://hazyresearch.stanford.edu/blog/2025-11-17-pk) (Nov 2025)
* [**We Bought the Whole GPU, So We're Damn Well Going to Use the Whole GPU**](https://hazyresearch.stanford.edu/blog/2025-09-28-tp-llama-main) (Sep 2025)
* [**How Many Llamas Can Dance in the Span of a Kernel?**](https://hazyresearch.stanford.edu/blog/2025-09-28-tp-llama-intro) (Sep 2025)
* [**One Kernel for All Your GPUs**](https://hazyresearch.stanford.edu/blog/2025-09-22-pgl) (Sep 2025)
* [**1.5x Faster MoE Training with Custom MXFP8 Kernels Built From Scratch**](https://cursor.com/blog/kernels) (Aug 2025)
* [**Look Ma, No Bubbles! Designing a Low-Latency Megakernel for Llama-1B**](https://hazyresearch.stanford.edu/blog/2025-05-27-no-bubbles) (May 2025)

---

# Open Source

* [**Mixture-of-Kittens**](https://github.com/cursor/mixture-of-kittens) (New): Mixture-of-experts training megakernel for NVL72s.
* [**ThunderKittens/ParallelKittens**](https://github.com/HazyResearch/ThunderKittens) (3,600+ stars): Tile primitives for fast AI kernels. Adopted by Cursor, Together AI, Jump Trading, Modular, TileLang, and Nvidia CuTe 4.0.
* [**Megakernels**](https://github.com/HazyResearch/Megakernels) (700+ stars): Framework for running an entire LLM as a single fused GPU kernel ("megakernel"). Includes implementations of FlashMLA, Llama 3 1B, and 8-GPU Llama 3 70B.
* [**GPU Experiments**](https://github.com/StuartSul/gpu-experiments): A collection of GPU experiments and benchmarks that I use for my personal understanding and research.
* [**MERCI**](https://github.com/SNU-ARC/MERCI): Fast embedding reduction algorithm for deep learning recommendation models (DLRMs) and other systems with very large embedding tables.
* [**ELF32 Dynamic Linker for Raspberry Pi**](https://github.com/StuartSul/elf32-dynamic-linker-rpi): ELF dynamic linker on bare metal, allowing you to port shared libraries. It is taught as a lab at Stanford: [CS 240LX: ELF and Dynamic Linker](https://github.com/dddrrreee/cs240lx-25spr/tree/main/labs/15-elf-dynamic-linker).
* [**Co-Chuck**](https://github.com/StuartSul/co-chuck): Collaborative online environment that allows you to "code" your music.

<!--
* [**SampyoNet**](https://github.com/StuartSul/SampyoNet): Deep learning model, inference engine, and mobile app combined for gravel quality assessment. Provided to Sampyo for production concrete manufacturing.
* [**LLVM** Compiler Optimization](https://github.com/StuartSul/SWPP2020_Spring_Project_Team4): Achieved 2nd place among 13 teams in an LLVM optimization competition at Seoul National University.
-->
